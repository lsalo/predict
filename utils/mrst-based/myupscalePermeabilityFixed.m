function perm = myupscalePermeabilityFixed(G,dp_scale,psolver,fluid_pure,L)
% function for doing permeability upscaling on grids with fixed pressure 
% conditions (pressure drop in one direction and noflow elsewhere).
%
% perm =
...
for i=1:G.griddim
   ...
   state  = psolver(state,G,fluid_pure,bc);
